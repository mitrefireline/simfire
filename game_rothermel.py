...
from src.utils.layers import FunctionalFuelLayer, LatLongBox, OperationalTopographyLayer
...
def main():
    ...
    fuel_layer = FunctionalFuelLayer(topo_layer.data.shape[0], topo_layer.data.shape[1],
                                     cfg.terrain.fuel_array_function)
