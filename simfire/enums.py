...
# A lookup dictionary to calculate rate of dozer line creation - These rates are an average of reported rates/ranges
...
DozerLineRates = {
    3: {
        1 : {
            'up': {1: 73, 2: 43, 3: 19, 4: 4},
            'down': {1: 100, 2: 100, 3: 55, 4: 10}
        },
        2 : {
            'up': {1: 73, 2: 43, 3: 19, 4: 4},
            'down': {1: 100, 2: 100, 3: 55, 4: 10}
        ...
        3 : {
            'up': {1: 58, 2: 35, 3: 14, 4: 1},
            'down': {1: 75, 2: 73, 3: 33, 4: 0}
        },
        4 : {
            'up': {1: 28, 2: 15, 3: 5, 4: 0},
            'down': {1: 38, 2: 33, 3: 13, 4: 0}
        },
        5 : {
            'up': {1: 58, 2: 35, 3: 14, 4: 1},
            'down': {1: 75, 2: 73, 3: 33, 4: 0}
        ...
        6 : {
            'up': {1: 45, 2: 50, 3: 7, 4: 0},
            'down': {1: 58, 2: 50, 3: 20, 4: 0}
        },
        7 : {
            'up': {1: 45, 2: 50, 3: 7, 4: 0},
            'down': {1: 58, 2: 50, 3: 20, 4: 0}
        ...
        10 : {
            'up': {1: 12, 2: 6, 3: 2, 4: 0},
            'down': {1: 13, 2: 8, 3: 3, 4: 0}
        },
        11 : {
            'up': {1: 20, 2: 11, 3: 4, 4: 0},
            'down': {1: 28, 2: 15, 3: 5, 4: 0}
        },
        12 : {
            'up': {1: 20, 2: 11, 3: 4, 4: 0},
            'down': {1: 28, 2: 15, 3: 5, 4: 0}
    ...
    2: {
        1: {
            'up': {1: 105, 2: 73, 3: 45, 4: 15},
            'down': {1: 135, 2: 138, 3: 103, 4: 38}
        },
        2: {
            'up': {1: 105, 2: 73, 3: 45, 4: 15},
            'down': {1: 135, 2: 138, 3: 103, 4: 38}
        ...
        3: {
            'up': {1: 88, 2: 58, 3: 30, 4: 8},
            'down': {1: 113, 2: 113, 3: 80, 4: 28}
        },
        4: {
            'up': {1: 48, 2: 28, 3: 11, 4: 1},
            'down': {1: 68, 2: 71, 3: 43, 4: 10}
        },
        5: {
            'up': {1: 88, 2: 58, 3: 30, 4: 8},
            'down': {1: 113, 2: 113, 3: 80, 4: 28}
        ...
        6: {
            'up': {1: 68, 2: 40, 3: 19, 4: 4},
            'down': {1: 93, 2: 93, 3: 63, 4: 20}
        },
        7: {
            'up': {1: 68, 2: 40, 3: 19, 4: 4},
            'down': {1: 93, 2: 93, 3: 63, 4: 20}
        ...
        10: {
            'up': {1: 15, 2: 9, 3: 4, 4: 0},
            'down': {1: 23, 2: 23, 3: 10, 4: 0}
        },
        11: {
            'up': {1: 33, 2: 20, 3: 8, 4: 1},
            'down': {1: 48, 2: 50, 3: 23, 4: 0}
        },
        12: {
            'up': {1: 33, 2: 20, 3: 8, 4: 1},
            'down': {1: 48, 2: 50, 3: 23, 4: 0}
    ...
    1: {
        1: {
            'up': {1: 120, 2: 85, 3: 53, 4: 18},
            'down': {1: 148, 2: 148, 3: 113, 4: 43}
        },
        2: {
            'up': {1: 120, 2: 85, 3: 53, 4: 18},
            'down': {1: 148, 2: 148, 3: 113, 4: 43}
        ...
        3: {
            'up': {1: 93, 2: 63, 3: 35, 4: 10},
            'down': {1: 120, 2: 120, 3: 83, 4: 43}
        },
        4: {
            'up': {1: 48, 2: 38, 3: 19, 4: 4},
            'down': {1: 75, 2: 80, 3: 50, 4: 13}
        },
        5: {
            'up': {1: 93, 2: 63, 3: 35, 4: 10},
            'down': {1: 120, 2: 120, 3: 83, 4: 43}
        ...
        6: {
            'up': {1: 80, 2: 53, 3: 28, 4: 8},
            'down': {1: 103, 2: 103, 3: 70, 4: 25}
        },
        7: {
            'up': {1: 80, 2: 53, 3: 28, 4: 8},
            'down': {1: 103, 2: 103, 3: 70, 4: 25}
        ...
        10: {
            'up': {1: 28, 2: 15, 3: 5, 4: 0},
            'down': {1: 38, 2: 35, 3: 15, 4: 0}
        },
        11: {
            'up': {1: 45, 2: 28, 3: 12, 4: 2},
            'down': {1: 60, 2: 60, 3: 31, 4: 3}
        },
        12: {
            'up': {1: 45, 2: 28, 3: 12, 4: 2},
            'down': {1: 60, 2: 60, 3: 31, 4: 3}
